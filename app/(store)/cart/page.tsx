   ...
   order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
    ...
    {isSignedIn ? (
      <button
       ...
       disabled={isLoading}
       className="mt-4  w-full bg-green-400 hover:bg-green-500 text-white px=4 py-2 roundes disabled:bg-gray-400"
      >
        {isLoading? "Processing..." : "Checkout"}
      </button>
    ):(
      <SignInButton mode="modal">
        <button className="mt-4 w-full bg-green-400 text-white px-4 py-2 rounded
        hover:bg-green-400">
          Sign In to Checkout         
        </button>
      </SignInButton>
